...
fun generateStructureMapLine(structureMapBody: StringBuilder, row: Row, resource: Resource, extractionResources: HashMap<String, Resource>, resourceName: String,resourceIndex: Int)  {
