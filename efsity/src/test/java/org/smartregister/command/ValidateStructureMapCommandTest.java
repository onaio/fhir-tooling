...
public class ValidateStructureMapCommandTest {
    ...
    public void setUp() throws IOException {
        ...
        try (FileWriter writer = new FileWriter(tempFile)) {
            writer.write("{\"questionnaire1\": \"structureMap1\", \"questionnaire2\": \"structureMap2\"}");
        }
    }
    ...
    public void testParseCompositionFile() throws IOException {
        Map<String, String> result = validateStructureMapCommand.parseCompositionFile(tempFile.getAbsolutePath());
