...
dependencies {
  ...
  implementation(deps.org.hl7.fhir.r4)
  implementation(deps.org.hl7.fhir.utilities)
  ...
  implementation(deps.model)
  implementation(deps.elm)
  implementation(deps.cql.to.elm)
  implementation(deps.elm.jackson)
  implementation(deps.model.jackson)
  implementation(deps.jackson.annotations)
  implementation(deps.jackson.core)
  implementation(deps.jackson.databind)
  implementation(deps.engine)
  implementation(deps.engine.jackson)
  implementation(deps.evaluator)
  implementation(deps.evaluator.builder)
  implementation(deps.evaluator.dagger)
  implementation(deps.evaluator.plandefinition)
